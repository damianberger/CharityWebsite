document.addEventListener("DOMContentLoaded", function () {
    ...
    class FormSteps {
        ...
        updateForm() {
            ...
            document.getElementById('streetSummary').innerHTML = document.getElementById('street').value;
            document.getElementById('citySummary').innerHTML = document.getElementById('city').value;
            document.getElementById('zipCodeSummary').innerHTML = document.getElementById('zipCode').value;
            document.getElementById('phoneSummary').innerHTML = document.getElementById('phone').value;
            document.getElementById('pickUpDateSummary').innerHTML = document.getElementById('pickUpDate').value;
            document.getElementById('pickUpTimeSummary').innerHTML = document.getElementById('pickUpTime').value;
